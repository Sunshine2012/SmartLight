...
#define CFG_APP  
/////////////////////////////////////////////////////////////
/* GAP role*/  // 角色 aiwesky 20151003
#define CFG_APP_PERIPHERAL
/////////////////////////////////////////////////////////////
/* Proprietary Serial Port Service host profile role */
//#define CFG_PRF_SPS_CLIENT
/* Proprietary Serial Port Service device profile role */
#define CFG_PRF_SPS_SERVER	// 	包含了SPS_SERVER的服务 aiwesky 20151003
/////////////////////////////////////////////////////////////

#define CFG_PRF_DISS        1   // 设备的information aiwesky 20151004

#define CFG_PRF_BASS        1   // 电池服务 aiwesky 20101005

#define CFG_PRF_WECHAT      1   // 微信服务 aiwesky 20151004

//#define CFG_PRF_SAMPLE128  1   // aiwesky 20151004
//#define CFG_PRF_SPOTAR      1   // 升级服务 aiwesky 20151005
...
/* Coarse calibration */
#define CFG_LUT_PATCH  // 压控锁相环，不能被用户改变 aiwesky 20151003
...
#define MSG_HEAP_SZ             1516 //  remove 500 bytes because we didnt have enough space for the attribute of the streamdataproject Original: 1312	
#define NON_RET_HEAP_SZ         2560 // Original: 1024	
//#endif

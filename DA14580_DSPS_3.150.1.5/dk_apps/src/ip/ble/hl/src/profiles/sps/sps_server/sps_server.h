...
//#define SPS_SERVICE_UUID                {0xE7, 0xFE}
//#define SPS_SERVER_TX_UUID 				{0xC7, 0xFE}
//#define SPS_SERVER_RX_UUID				{0xC8, 0xFE}
//#define SPS_FLOW_CTRL_UUID			 	{0xC9, 0xFE}
...
// Size of a single sps_server packet in bytes
#define BLE_MAX_PACKET_SIZE 	(uint8_t)	20
#define BLE_MAX_PACKET_COUNT	(uint8_t)	6
...
/**
 ****************************************************************************************
 * @brief Check if the received handles are the same as the receive attributes
 ****************************************************************************************
 */
bool sps_server_received_correct_write_handle(uint16_t handle);

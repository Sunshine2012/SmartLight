...
//#define APP_DIS_MANUFACTURER_NAME       ("Dialog Semi")  // aiwesky 20151004
#define APP_DIS_MANUFACTURER_NAME       ("DA_SmartLight")
#define APP_DIS_MANUFACTURER_NAME_LEN   (13)
/// Model Number String (up to 18 chars)
#define APP_DIS_MODEL_NB_STR            ("DA14580_SmartLight")
#define APP_DIS_MODEL_NB_STR_LEN        (18)

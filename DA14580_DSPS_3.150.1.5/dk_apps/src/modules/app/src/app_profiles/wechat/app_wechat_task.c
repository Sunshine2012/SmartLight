...
#include "wechat_task.h"            // Device Information Service Server Task API
#include "wechat.h"                 // Device Information Service Definitions
#include "app_wechat.h"             // Device Information Service Application Definitions
#include "app_wechat_task.h"        // Device Information Service Application Task API
...
/*
            {
                ...
                struct diss_set_char_val_req *req_name = KE_MSG_ALLOC_DYN(DISS_SET_CHAR_VAL_REQ,
                                                                          ...
                                                                          APP_WECHAT_MANUFACTURER_NAME_LEN);
